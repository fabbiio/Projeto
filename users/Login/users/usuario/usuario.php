        ...
        <nav class="menu">
            <ul class="opcoes">
                ...
                <li>
                    <a href="#">Cadastrar</a>
                    <ul class="cadastrar">
                        <li><a href="../produto/cadastro/cadastro_variados.php">Variados</a> </li>  
                        <li><a href="../produto/cadastro/cadastro_perecivel.php">Pereciveis</a> </li> 
                    </ul>
                </li>

                <li ><a href="#" >Estoque</a>
                    <ul class="cadastrar">
                        <li><a href="../produto/consulta/produtos.php"> Consultar</a></li>
