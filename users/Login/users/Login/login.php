<?php
    ...
    if (isset($_POST['email']) and !empty(($_POST['email']))) {
        ...
        if ($exec->num_rows > 0) {
            ...
            header('Location: ' . BASEURL . 'users/Login/login.php?msg=1');
        }
    }
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="post" action="">
					...
					<div class="text-center p-t-136">
						<a class="txt2" href="<?php echo BASEURL?>adm/login">
							Portal Administrador
							<i class="fa " aria-hidden="true"></i>
						</a>
						<br>
						<a class="txt2" href="<?php echo BASEURL?>users/usuario/cadastro_usuario.php">
							Criar nova Conta
