<?php
    session_start();
    require_once('./Index/conexao.php');
    ...
    {
        $data = $_GET['search'];
        $sql = "SELECT * FROM produto WHERE  (id LIKE '%$data%' or nome LIKE '%$data%' or tipo like '%$data%' or marca LIKE '%$data%') and  id_usuario ='$id_usuario'";
    }
    else{
...
<body>
    ...
    <nav>
        <ul>
            <li><a href="./Index/cadastro.php">Cadastrar item</a></li>
            <li><a href="#">Importar</a></li>
            <li><a href="./Index/gerar_planilha.php">Exportar</a></li>                      
            <a class="logout" href="./Login_v1/login.php" class="logout">Logout</a>           
        </ul>
    </nav>
    <div>
        <table class="tabela">      
        ...
        <div>
            ...
            <tbody >
                <?php
                    ...
                    while($user_data = mysqli_fetch_assoc($result)){
                        ...
                        echo "<td> 
                                ...
                                <a class='btn btn-sm btn-primary' href='./Index/atualizar.php?id=$user_data[id]' title='Editar'>
                                ...
                                <a class='btn btn-sm btn-danger' href='./Index/deletar.php?id=$user_data[id]'>
                ...
                <tr>
                   ...
                   <td colspan="3" style="background-color:dodgerblue;color:white">Total</td> 
                   <td style="background-color:dodgerblue;color:white"><?php echo $total1;?></td>
                   <td style="background-color:dodgerblue;color:white">R$ <?php echo number_format($total2,2,",",".");?></td>
                   <td style="background-color:dodgerblue;color:white"></td>
                   <td style="background-color:dodgerblue;color:white">R$ <?php echo number_format($total3,2,",",".");?></td>
                   <td style="background-color:dodgerblue;color:white"></td>
